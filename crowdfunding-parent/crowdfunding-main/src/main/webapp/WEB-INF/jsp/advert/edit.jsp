      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li><a href="${APP_PATH}/advert/index.html">广告列表</a></li>
			  ...
			  <div class="panel-body">
				<form role="form" id="roleForm">
				  <div class="form-group">
					...
					<!-- 设置隐藏域，用于保存id -->
					<input type="hidden" class="form-control" id="fid" value="${advert.id}">
					<input type="text" class="form-control" id="fname" value="${advert.name}">
				  </div>
				  <div class="form-group">
					<label for="furl">广告地址</label>
					<input type="text" class="form-control" id="furl" value="${advert.url}">
				  </div>
				  <div class="form-group">
					<label for="ficonpath">广告图片</label>
					<input type="file" class="form-control" id="ficonpath" value="${advert.iconpath}">
				  </div>
	...
	<script src="${APP_PATH}/script/common.js"></script>
        <script type="text/javascript">
			...
			$("#resetBtn").click(function(){
            	$("#roleForm")[0].reset();	// 将JQuery对象装化为DOM对象，调用DOM对象的重置方法
            });
         	// 修改角色
