        		...
        		success : function(data){
        			...
        			if(data.success){
        				...
        				$.each(pageContent.resultList, function(i,rst){
        					...
        					content+='<td>';
        					content+='<button type="button" class="btn btn-success btn-xs" onclick="window.location.href=\'${APP_PATH}/role/assignRole.html?userid='+ rst.id +'\'"><i class=" glyphicon glyphicon-check"></i></button>';
