			  ...
			  <div class="panel-body">
				<form role="form" id="userForm">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="ficon" placeholder="请输入许可图标">
				  </div>
				  <div class="form-group">
					<label for="furl">许可地址</label>
					<input type="email" class="form-control" id="furl" placeholder="请输入许可地址">
				  </div>
